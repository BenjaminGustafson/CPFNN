...
# settings
class Config(object):
    #Common dimensions (CpG sites) we used: 473034 303236 9607 8105 8195. 
    ...
    def train_by_random(self, train):
        for t in range(0,self.epoch):
            ...
            for i in range(0,ceil(len(x_train) // self.batch_size)): #loop through train set by batch size
                ...
                y_pred = self.model(random_train) #get prediction from neural network
...
print('beta = ', opt.beta)
print('l1_ratio = ', opt.l1_ratio)
print('batch_size = ', opt.batch_size)
print('cor = ', opt.cor)
print('num_sites = ', opt.num_sites)
print('hidden_dim = ', opt.hidden_dim)
print('train_file_path = ',  opt.train_file_path)
print('test_file_path = ', opt.test_file_path) 
